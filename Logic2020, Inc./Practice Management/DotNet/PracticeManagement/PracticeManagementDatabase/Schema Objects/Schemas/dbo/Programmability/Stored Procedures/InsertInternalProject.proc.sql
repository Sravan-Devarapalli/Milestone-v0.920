...
BEGIN
	...
	INSERT INTO dbo.Project(ClientId, Discount, Terms, ProjectNumber, PracticeId, ProjectStatusId, Name, GroupId, IsChargeable, IsAdministrative, IsAllowedtoShow, IsInternal, CanCreateCustomWorkTypes, IsNoteRequired, IsSeniorManagerUnassigned,IsBusinessDevelopment)
	VALUES (@ClientId,0.0,0,@ProjectNumber,@PracticeId,3,@Name,@GroupId,1,0,0,1,1,1,0,0)
END
