	...
	*/
	...
	BEGIN
		...
		SELECT @CurrentPMTime
				...
				,1
				,1 --Here it is Auto generated.
				,CASE WHEN @PersonId IS NOT NULL AND c.DayOff <> @DayOff AND @IsFloatingHoliday = 0 THEN 1 ELSE NULL END--Setting Approved Status flag for PTO entries from Calendar page.
		FROM MilestonePerson mp 
