...
namespace PraticeManagement.PersonService
{
    ...
    public interface IPersonService
    {
        ...
        [System.ServiceModel.OperationContractAttribute(Action = "http://tempuri.org/IPersonService/GetActivePersonsListShortByDivision", ReplyAction = "http://tempuri.org/IPersonService/GetActivePersonsListShortByDivisionResponse")]
        DataTransferObjects.Person[] GetActivePersonsListShortByDivision(int divisionId);
        ...
        [System.ServiceModel.OperationContractAttribute(Action = "http://tempuri.org/IPersonService/CheckIfCommissionsExistsAfterTermination", ReplyAction = "http://tempuri.org/IPersonService/CheckIfCommissionsExistsAfterTerminationRespons" +
            "e")]
    ...
    public partial class PersonServiceClient : System.ServiceModel.ClientBase<PraticeManagement.PersonService.IPersonService>, PraticeManagement.PersonService.IPersonService
    {
        ...
        public DataTransferObjects.Person[] GetActivePersonsListShortByDivision(int divisionId)
        {
            return base.Channel.GetActivePersonsListShortByDivision(divisionId);
        }
