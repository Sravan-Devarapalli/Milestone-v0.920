...
<asp:Content ID="Content4" ContentPlaceHolderID="body" runat="server">
    ...
    <table class="CompPerfTable WholeWidth">
        <tr>
            <td colspan="2" style="background: #e2ebff; width: 100%; border-bottom: 1px solid black;">
                <asp:UpdatePanel ID="upTopBarPane" runat="server">
                    <ContentTemplate>
                                        ...
                                        <tr align="center">
                                            <td style="white-space: nowrap; padding-right: 25px;">
                                                <asp:ImageButton ID="imgBtnFirst" Visible="false" runat="server" Style="z-index: 1;"
                                                    ImageUrl="~/Images/arrow-First.png" OnClientClick="if (!confirmSaveDirty(true)) return false;"
                                            ...
                                            <td style="white-space: nowrap; padding-right: 25px;">
                                                <asp:ImageButton ID="imgBtnPrevious" Visible="false" runat="server" Style="z-index: 1;"
                                                    ImageUrl="~/Images/arrow-Previous.png" OnClientClick="if (!confirmSaveDirty(true)) return false;"
                                            ...
                                            <td style="white-space: nowrap; padding-right: 25px;">
                                                <asp:ImageButton ID="imgBtnNext" runat="server" Style="z-index: 1;" ImageUrl="~/Images/arrow-Next.png"
                                                    OnClick="imgBtnNext_OnClick" Visible="true" ToolTip="Next Opportunity" OnClientClick="if (!confirmSaveDirty(true)) return false;" />
                                            ...
                                            <td style="white-space: nowrap; padding-right: 25px;">
                                                <asp:ImageButton ID="imgBtnLast" runat="server" Style="z-index: 1;" ImageUrl="~/Images/arrow-Last.png"
                                                    OnClientClick="if (!confirmSaveDirty(true)) return false;" OnClick="imgBtnLast_OnClick"
        ...
        <tr>
            <td id="columnOpportunityList" runat="server" style="border-right: 2px solid black;
                width: 20%;">
                <asp:UpdatePanel ID="upOpportunityList" runat="server">
                    <ContentTemplate>
                        <div style="overflow-y: scroll; height: 690px">
                            <asp:ListView ID="lvOpportunities" runat="server" SelectedIndex="0" DataKeyNames="Id"
                                ...
                                <ItemTemplate>
                                    <tr style="border-bottom: 1px solid black; padding: 2px 0px 2px 0px;" onclick="if (!confirmSaveDirty(true)) return false;">
                                        <td style="font-weight: bold; padding-right: 4px; padding-left: 2px; width: 5%;">
                                                ...
                                                <div class="WholeWidth">
                                                    <table class="WholeWidth">
                                                        <tr style="width: 100%;">
                                                            ...
                                                            <td valign="top" style="width: 25%; padding-right: 2px">
                                ...
                                <SelectedItemTemplate>
                                    <tr style="background-color: #e2ebff; border-bottom: 1px solid black; padding: 2px 0px 2px 0px;
                                        width: 5%;">
                                    ...
                                    <tr>
                                        <td>
                                            <asp:ImageButton runat="server" CssClass="DefaultCursor" ID="imgTransparent" ImageUrl="~/Images/Transparent.png"
                                                BorderStyle="None" />
                                        </td>
                                    </tr>
                                </SelectedItemTemplate>
            ...
            <td style="border-left: 2px solid black; padding-left: 5px; width: 80%;" valign="top">
                <table>
                    <tr>
                        <td style="height: 98%">
                            <div style="overflow-y: scroll; height: 690px">
                                                ...
                                                <ContentTemplate>
                                                    <div>
                                                        <table class="WholeWidth">
                                                            ...
                                                            <tr>
                                                                <td style="padding: 0px 5px 0px 4px;">
                                                                    <asp:TextBox ID="txtDescription" runat="server" TextMode="MultiLine" Rows="5" CssClass="WholeWidth"
                                                                        Height="80px" onchange="EnableSaveButton();setDirty();" MaxLength="2000" Style="overflow-y:auto;resize: none;
                                                                        font-size: 12px; font-family: Arial, Helvetica, sans-serif;"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td>
                                                            ...
                                                            <tr>
                                                                <td style="max-height: 110px; width: 100%; padding-left: 4px; vertical-align: top;">
                                                                    <asp:ListView ID="lvNotes" runat="server" EnableModelValidation="True">
                                                                        ...
                                                                        <EmptyDataTemplate>
                                                                            <tr>
                                                                                <td colspan="3" valign="middle" style="padding-left: 4px;">
                                                                                    <div>
                                                                                        <asp:Label ID="lblNoNotes" runat="server" Text="No Notes." CssClass="lblNoNotes"></asp:Label></div>
                                                                                </td>
                                                                            </tr>
                                                                        </EmptyDataTemplate>
                                                                    </asp:ListView>
    ...
    <asp:Panel ID="pnlAttachToProject" runat="server" BackColor="White" BorderColor="Black"
        ...
        <asp:UpdatePanel ID="upnlAttachToProject" runat="server">
            <ContentTemplate>
                <table width="100%">
