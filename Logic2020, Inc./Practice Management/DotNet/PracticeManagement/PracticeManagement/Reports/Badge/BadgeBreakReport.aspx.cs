...
namespace PraticeManagement.Reports.Badge
{
    public partial class BadgeBreakReport : System.Web.UI.Page
    {
        ...
        public void PopulateData()
        {
            ...
            var resources = ServiceCallers.Custom.Report(r => r.ListBadgeResourcesByType(paytypes,dtpStart.DateValue, dtpEnd.DateValue, false, false, false, true, false).ToList());
        ...
        protected void btnExportToExcel_OnClick(object sender, EventArgs e)
        {
            ...
            var paytypes = cblPayTypes.areAllSelected ? null : cblPayTypes.SelectedItems;
            var report = ServiceCallers.Custom.Report(r => r.ListBadgeResourcesByType(paytypes,dtpStart.DateValue, dtpEnd.DateValue, false, false, false, true, false).ToList());
            if (report.Count > 0)
            {
