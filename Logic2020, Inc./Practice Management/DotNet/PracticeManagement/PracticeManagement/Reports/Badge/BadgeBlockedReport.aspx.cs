...
namespace PraticeManagement.Reports.Badge
{
    public partial class BadgeBlockedReport : System.Web.UI.Page
    {
        ...
        public void PopulateData()
        {
            ...
            var resources = ServiceCallers.Custom.Report(r => r.ListBadgeResourcesByType(paytypes,statuses,dtpStart.DateValue, dtpEnd.DateValue, false, false, true, false, false).ToList());
        ...
        protected void btnExportToExcel_OnClick(object sender, EventArgs e)
        {
            ...
            var paytypes = cblPayTypes.areAllSelected ? null : cblPayTypes.SelectedItems;
            var statuses = PersonStatus;
            var report = ServiceCallers.Custom.Report(r => r.ListBadgeResourcesByType(paytypes, statuses, dtpStart.DateValue, dtpEnd.DateValue, false, false, true, false, false).ToList());
            if (report.Count > 0)
            {
