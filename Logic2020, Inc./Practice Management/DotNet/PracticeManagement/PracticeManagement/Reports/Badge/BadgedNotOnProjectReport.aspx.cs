...
namespace PraticeManagement.Reports.Badge
{
    public partial class BadgedNotOnProjectReport : System.Web.UI.Page
    {
        ...
        public void PopulateData()
        {
            ...
            var resources = ServiceCallers.Custom.Report(r => r.ListBadgeResourcesByType(dtpStart.DateValue, dtpEnd.DateValue, true, false, false, false,false).ToList());
        ...
        protected void btnExportToExcel_OnClick(object sender, EventArgs e)
        {
            ...
            var report = ServiceCallers.Custom.Report(r => r.ListBadgeResourcesByType(dtpStart.DateValue, dtpEnd.DateValue, true, false, false, false,false).ToList());
            if (report.Count > 0)
            {
