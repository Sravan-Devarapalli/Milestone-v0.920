        ...
        private byte[] RenderPdf(HtmlToPdfBuilder builder, List<Project> projects)
        {
            ...
            if (projects.Count > 0)
            {
                ...
                foreach (var project in projects)
                {
                    ...
                    project.EndDate.HasValue ? project.EndDate.Value.ToString(Constants.Formatting.EntryDateFormat) : string.Empty, project.Practice.Name, capabilitiesText, project.ProjectManagerNames, project.ExecutiveInChargeName);
                }
