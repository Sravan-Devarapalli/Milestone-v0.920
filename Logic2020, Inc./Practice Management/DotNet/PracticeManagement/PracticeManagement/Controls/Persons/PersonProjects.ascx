...
<asp:GridView ID="gvProjects" runat="server" AutoGenerateColumns="False" EmptyDataText="There is nothing to be displayed here"
    ...
    CssClass="CompPerfTable gvProjects_PersonProjects">
    <Columns>
        <asp:TemplateField>
            <HeaderTemplate>
                <div class="ie-bg">
        ...
        <asp:TemplateField>
            ...
            <ItemTemplate>
                <div class="cell-pad">
                    <asp:Label ID="Label2" runat="server" Text='<%# Bind("StartDate", "{0:MM/dd/yyyy}") %>'></asp:Label></div>
            </ItemTemplate>
            <EditItemTemplate>
        ...
        <asp:TemplateField>
            ...
            <ItemTemplate>
                <div class="cell-pad">
                    <asp:Label ID="Label3" runat="server" Text='<%# Bind("EndDate", "{0:MM/dd/yyyy}") %>'></asp:Label></div>
            </ItemTemplate>
            <EditItemTemplate>
            ...
            <ItemTemplate>
                <div class="cell-pad">
                    <asp:Label ID="lblRevenue" runat="server" Text='<%# ((PracticeManagementCurrency)((decimal)Eval("Revenue"))).ToString() %>'
                        CssClass="Revenue"></asp:Label></div>
            </ItemTemplate>
            <FooterTemplate>
...
<asp:ObjectDataSource ID="odsProjects" runat="server" SelectMethod="GetPersonMilestoneWithFinancials"
