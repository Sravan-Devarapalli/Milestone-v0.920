    ...
    <tr>
        <td colspan="4" class="Width90Percent PaddingBottom3">
            ...
            <asp:Button ID="btnGroupBySales" runat="server" Text="Group By Sales Stage" UseSubmitBehavior="false"
                CssClass="Width130px" OnClick="btnGroupBySales_OnClick" ToolTip="Group By Sales Stage" />
                    ...
                    <tr class="headerRow">
                        ...
                        <th class="ForthTD">
                         <asp:LinkButton ID="btnSalesStage" runat="server" CausesValidation="false"
                                CommandArgument="SalesStage" Style="text-decoration: none; color: Black;"
        ...
        <table class="ConsultingDemandDetailsByMonth">
            <tr class="bgColorD4D0C9 textLeft">
                <td colspan="7" class="padLeft20Imp no-wrap Width70Per">
                    <AjaxControlToolkit:CollapsiblePanelExtender ID="cpeDetailsByMonth" runat="Server" CollapsedText="Expand Month Details"
                        ExpandedText="Collapse Month Details" EnableViewState="true" BehaviorID="cpeDetailsByMonth"
                ...
                <thead>
                    <tr class="headerRow">
                        <th class="FirstTDSalesStage">
                            <asp:LinkButton ID="btnSalesStageGroupBy" runat="server" CausesValidation="false" CommandArgument="TitleSkill"
                                Style="text-decoration: none; color: Black; width: 100%;" OnCommand="btnSalesStageGroupBy_Command">
                          Sales Stage
                          </asp:LinkButton>
                        </th>
                        <th class="Width20">
                         <asp:LinkButton ID="btnSalesStageTitleSkill" runat="server" CausesValidation="false"
                                CommandArgument="SalesStage" Style="text-decoration: none; color: Black;"
                                OnCommand="btnSalesStageTitleSkill_Command">
                           Title/Skill Set
                            </asp:LinkButton>
                        </th>
                        <th class="FifthTD">
                        ...
                        <th class="FifthTD">
                            <asp:LinkButton ID="btnSalesStageProjectNumber" runat="server" CausesValidation="false" CommandArgument="SalesStageProjectNumber"
                                Style="text-decoration: none; color: Black;" OnCommand="btnSalesStageProjectNumber_Command">
                            Project Number
                            </asp:LinkButton>
                        </th>
                        <th class="Width20">
                            <asp:LinkButton ID="btnSalesStageAccountName" runat="server" CausesValidation="false" CommandArgument="SalesStageAccountName"
                                Style="text-decoration: none; color: Black;" OnCommand="btnSalesStageAccountName_Command">
                            Account Name
                            </asp:LinkButton>
                        </th>
                        <th class="Width20">
                            <asp:LinkButton ID="btnSalesStageProjectName" runat="server" CausesValidation="false" CommandArgument="SalesStageProjectName"
                                Style="text-decoration: none; color: Black;" OnCommand="btnSalesStageProjectName_Command">
                            Project Name
                            </asp:LinkButton>
                        </th>
                        <th class="SecondTD">
