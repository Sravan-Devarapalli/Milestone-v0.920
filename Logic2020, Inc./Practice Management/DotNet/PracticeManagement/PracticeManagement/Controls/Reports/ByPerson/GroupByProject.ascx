...
<table style="background-color: rgb(245, 250, 255);" class="WholeWidthWithHeight">
    <tr style="text-align: left;">
        ...
        <td style="width: 5%; font-weight: bolder; font-size: 16px; text-align: right; padding-right: 10px;">
                        ...
                        <tr style="text-align: left; background-color: #D4D0C9;">
                            <td style="width: 80%; padding-left: 20px;">
                                <AjaxControlToolkit:CollapsiblePanelExtender ID="cpeDate" runat="Server" CollapsedText="Expand Date Details"
                                    ...
                                    Collapsed="false" TargetControlID="pnlDateDetails" ImageControlID="imgDate" CollapsedImage="~/Images/expand.jpg"
