...
namespace PraticeManagement.Controls.Projects
{
    public partial class ProjectActivityLog : System.Web.UI.UserControl
    {
        ...
        protected void btnExcel_Click(object sender, EventArgs e)
        {
            ...
            var report = ActivityLogHelper.GetActivities(SourceFilter, StartDateFilter, EndDateFilter, PersonId, ProjectId, OpportunityIdFilter, MilestoneIdFilter, StartRow, MaxRow, PracticeAreas, SowBudget, Director, POAmount, Capabilites, NewOrExtension, PoNumber, ProjectStatus, SalesPerson, ProjectOwner, true).ToList();
