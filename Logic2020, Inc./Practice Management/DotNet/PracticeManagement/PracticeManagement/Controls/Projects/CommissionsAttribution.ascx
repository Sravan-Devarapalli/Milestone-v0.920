    ...
    <table class="WholeWidth">
        ...
        <tr style="height: 10%">
            <td class="Width47Percent AlignRight PaddingBottom2 borderLeftRight_black">
                <asp:Button ID="btnAddDeliveryAttributionResource" runat="server" Text="Add Resource" Attribution="1"
                    OnClick="btnAddRecord_Click" />
            </td>
            <td class="Width6PercentImp">
            </td>
            <td class="Width47Percent AlignRight PaddingBottom2 borderLeftRight_black">
                <asp:Button ID="btnAddSalesAttributionResource" runat="server" Text="Add Resource" Attribution="2"
                    OnClick="btnAddRecord_Click" />
            </td>
        </tr>
        <tr style="height: 45%">
            <td class="Width47Percent vTop borderLeftRight_black">
                <asp:GridView ID="gvDeliveryAttributionPerson" runat="server" AutoGenerateColumns="False" Attribution="1"
                        ...
                        <asp:TemplateField>
                            ...
                            <ItemTemplate>
                                <asp:ImageButton ID="imgDeliveryAttributionAdditionalAllocationOfResource" runat="server"
                                    ToolTip="Extend" OnClick="imgAdditionalAllocationOfResource_Click"
            ...
            <td class="Width6PercentImp">
             ...
             <td class="Width47Percent vTop borderLeftRight_black">
                    <asp:GridView ID="gvSalesAttributionPerson" runat="server" AutoGenerateColumns="False" Attribution="2"
                        CssClass="CompPerfTable MileStoneDetailPageResourcesTab" EditRowStyle-Wrap="false"
                        EmptyDataText="No persons were assigned to this attribution." RowStyle-Wrap="false" HeaderStyle-Wrap="false" GridLines="None"
        ...
        <tr style="height: 10%">
            <td class="Width47Percent AlignRight PaddingTop6 PaddingBottom2 borderLeftRight_black">
                <asp:Button ID="btnAddDeliveryAttributionPractice" runat="server" Text="Add Practice" Attribution="3"
                    OnClick="btnAddRecord_Click" />
            </td>
             <td class="Width6PercentImp">
            </td>
             <td class="Width47Percent AlignRight PaddingTop6 PaddingBottom2 borderLeftRight_black">
                    <asp:Button ID="btnAddSalesAttributionPractice" runat="server" Text="Add Practice" Attribution="4"
                        OnClick="btnAddRecord_Click" />
                </td>
        </tr>
        <tr style="height: 25%">
            <td class="Width47Percent vTop border_blackExceptTop">
                <asp:GridView ID="gvDeliveryAttributionPractice" runat="server" AutoGenerateColumns="False" Attribution="3"
                    CssClass="CompPerfTable MileStoneDetailPageResourcesTab" EditRowStyle-Wrap="false"
            ...
            <td class="Width6PercentImp">
                ...
                <td class="Width47Percent vTop border_blackExceptTop">
                    <asp:GridView ID="gvSalesAttributionPractice" runat="server" AutoGenerateColumns="False" Attribution="4"
                        CssClass="CompPerfTable MileStoneDetailPageResourcesTab" EditRowStyle-Wrap="false"
                        EmptyDataText="No practices were assigned to this attribution." RowStyle-Wrap="false" HeaderStyle-Wrap="false" GridLines="None"
                        BackColor="White" OnRowDataBound="gvSalesAttributionPractice_RowDataBound">
                        <AlternatingRowStyle CssClass="alterrow" />
                        <HeaderStyle CssClass="textCenter" />
                        <Columns>
                            <asp:TemplateField>
