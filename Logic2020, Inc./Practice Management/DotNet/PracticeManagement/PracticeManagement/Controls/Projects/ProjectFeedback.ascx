...
<asp:UpdatePanel ID="upnlBody" runat="server">
    <ContentTemplate>
        <asp:Repeater ID="repFeedback" runat="server" OnItemDataBound="repFeedback_ItemDataBound">
            ...
            <ItemTemplate>
                <tr class="ReportItemTemplate">
                    ...
                    <td>
                        <asp:DropDownList ID="ddlStatus" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlStatus_SelectedIndexChanged" CausesValidation="false">
                        </asp:DropDownList>
                         <asp:LinkButton ID="lnkCanceled" runat="server" FeedbackId='<%# Eval("Id")%>' FeedbackReason='<%# Eval("CancelationReason")%>' Text="Canceled"
        ...
        <div id="divEmptyMessage" class="EmptyMessagediv" style="display: none;" runat="server">
            There are no milestone entries more than 6 weeks.
        </div>
        ...
        <asp:Panel ID="pnlCacelationReason" runat="server" Style="display: none;Width:420px;" CssClass="pnlTimeEntryCss">
            <table>
                <tr>
