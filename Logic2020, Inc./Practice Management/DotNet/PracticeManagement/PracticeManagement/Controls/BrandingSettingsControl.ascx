...
<tr>
    <td>
        <label class="no-wrap" for="<%=tbTitle.ClientID%>">Company Name</label>
    </td>
...
<tr>
    <td>
        <label class="no-wrap"  for="<%=fuImagePath.ClientID%>">Company Logo</label>
    </td >
    <td style="padding-right:5px;position: relative;">
      <asp:FileUpload ID="fuImagePath" BackColor="White"  onchange="EnableSaveButton(true);" runat="server"  Width="375px"  Size="56" /> 
...
<td >
    ...
    <td>
        ...
        <asp:Button ID="btnSave" runat="server" Text="Save All" CssClass="Margin-Left" OnClick="btnSave_Click" ValidationGroup="BrandingLogo" />
        <ext:ElementDisablerExtender ID="edeSave" runat="server" TargetControlID="btnSave" ControlToDisableID="btnSave" />
    </td>
</tr>
<tr>
    <td colspan="2">
    <asp:CustomValidator ID="cvImagePath" runat="server" ControlToValidate="fuImagePath" Display="None" OnServerValidate="cvImagePath_OnServerValidate" ValidationGroup ="BrandingLogo" Text="*" ErrorMessage ="Error occured. Can't save the settings: Invalid File Format."></asp:CustomValidator>
    <asp:CustomValidator ID="cvalidatorImagePath" runat="server" ControlToValidate="fuImagePath" Display="None" OnServerValidate="cvalidatorImagePath_OnServerValidate" ValidationGroup ="BrandingLogo" Text="*" ErrorMessage ="Error occured. Can't save the settings: Invalid File size."></asp:CustomValidator>
