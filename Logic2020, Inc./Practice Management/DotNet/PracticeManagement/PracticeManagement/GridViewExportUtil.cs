...
public class NPOIExcel
{
    ...
    {
        HSSFWorkbook hssfworkbook = GetWorkbook(dsInput, fileName);
    ...
    private static HSSFWorkbook GetWorkbook(List<DataSet> dsInput, string filename)
    {
        ...
        foreach (DataSet dataset in dsInput)
        {
            int i = 0;
            int tableStartRow = i;
            ISheet sheet = hssfworkbook.CreateSheet(dataset.Tables[0].TableName);
