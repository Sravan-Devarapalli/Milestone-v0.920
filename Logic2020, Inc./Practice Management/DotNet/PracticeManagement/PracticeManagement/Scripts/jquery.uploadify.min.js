...
b(this).bind("rfuCancel",{action:settings.onCancel},function(f,c,d,g){if(f.data.action(f,c,d,g)!==false){b("#"+b(this).attr("id")+c).fadeOut(250,function(){b("#"+b(this).attr("id")+c).remove();
...
b(this).bind("rfuError",{action:settings.onError},function(g,c,f,d){if(g.data.action(g,c,f,d)!==false){b("#"+b(this).attr("id")+c+" .fileName").text(d.type+" Error - "+f.name);
b("#"+b(this).attr("id")+c).css({border:"3px solid #FBCBBC","white-space":"normal"});
b("#"+b(this).attr("id")+c+"ProgressBar").css("background-color","#FDE5DD")
}});
